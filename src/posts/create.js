...
module.exports = function (Posts) {
    ...
    Posts.create = function (data) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const pid = yield database_1.default.incrObjectField(
                "global",
                "nextPid",
            );
            let postData = {
            ...
            try {
                const result = yield plugins_1.default.hooks.fire(
                    "filter:post.create",
                    { post: postData, data },
                );
                postData = result.post;
                yield database_1.default.setObject(
                    `post:${postData.pid}`,
                    postData,
                );
                const topicData = yield topics_1.default.getTopicFields(tid, [
                    "cid",
                    "pinned",
                ]);
                ...
                yield Promise.all([
                    ...
                    categories_1.default.onNewPostMade(
                        topicData.cid,
                        topicData.pinned,
                        postData,
                    ),
